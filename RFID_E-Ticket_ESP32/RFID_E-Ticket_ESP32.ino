...
#define RST_PIN 4  //--> RST is connected to pinout D1
...
WebServer server(7878);  //--> Server on port 80
...
void loop() {
  ...
  delay(500);
    ...
    http.begin("https://e-tiketpolines.my.id/admin/getUID.php");  //Specify request destination
