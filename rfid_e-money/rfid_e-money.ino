...
void loop()
{
  ...
  jumlah = stored_value.toInt() - 5000;     // 1000 is amount to substract with amount that has been read
  Serial.println(" ");
  ...
  Serial.println("Tarif : Rp.5000");
  if (jumlah <= 0) {
   // jumlah++;
    writeBlock(block, clear_blockcontent);
    Serial.print("Saldo Habis : Rp.0");
    Serial.println("Isi Ulang Saldo Anda");
  }
